import{i as pe,s as me,j as he,p as ve,M as g,S as ee,R as l,k as v,l as E,m as f,n as a,A as j,o as te,q as ie,C as m,u as H,v as fe,x as k,E as q,O as T,y as M,z as F,B as $,D,T as ge,F as be,G as ye,I as xe}from"./core-B3_92rvv.js";import{c as u,n as d,r as w,o as V,U as Ce}from"./index-BkszvSU2.js";import"./index-BzS8bQbh.js";import"./events-bD8YTXT7.js";import"./index.es-DquRt_IV.js";import"./index-BTJb-n1K.js";import"./index-nibyPLVP.js";import"./fallback-BhSuS70f.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(n){return he(p,()=>n(p))},subscribeKey(n,e){return me(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
